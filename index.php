...
<head>
  ...
  <!-- Index Credits:[🐉DragonBins] -->

	<title>[DragonBins] Merchant Stripe Checker</title>
...
<style>
body {
  background-image: url('DragonBins.jpg');
...
<div class="card col-sm-12">
  <h1 class="card-body h1"><span class="badge badge-dark rainbow_text_animated "><font size="300px">[DragonBins]</font></span>
</h1>
  <div class="card-body">
<div class="md-form">
  <div class="col-md-12">
...
<footer>
    <center><span class="badge badge-dark rainbow_text_animated "><h1>[DragonBins] Team </h1></span>
